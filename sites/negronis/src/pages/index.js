...
const Index = ({ data }) => (
  <Layout>
    <Image fluid={data.image.cloudinary.fluid} />
    ...
    <Link to="/recipes" sx={{ variant: 'button.primary', ml: 3 }}>Recepes</Link>
    <Link to="/history" sx={{ variant: 'button.hollow', ml: 3 }}>Learn the History</Link>
    <Link to="/events" sx={{ variant: 'button.hollow', ml: 3 }}>Events</Link>
  </Layout>
);
